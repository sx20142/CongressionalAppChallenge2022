...
import com.example.shareme.adapters.BorrowPostAdapter;
...
public class BorrowPostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_borrow_page, container, false);

        //initialize variables
        firebaseAuth = FirebaseAuth.getInstance();
        //recycler view and its properties
        recyclerView = view.findViewById(R.id.borrowPosts_recView);
